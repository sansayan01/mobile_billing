...
## Corpus Check
- 144 files · ~1,420,267 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1837 nodes · 2839 edges · 145 communities (111 shown, 34 thin omitted)
...
Cohesion: 0.04
Nodes (54): address1, address2, barcode, billId, cartItems, copyWith, customPrice, discountIsPercentage (+46 more)
...
Cohesion: 0.07
Nodes (34): RecentTransactionsCard, SalesTrendCard, appBarTheme, buildActions, _buildDescriptionSnippet, buildLeading, _buildLoadingPlaceholder, buildResults (+26 more)
...
Cohesion: 0.05
Nodes (39): dart:io, GlobalKey, address1, address2, billId, cartItems, createState, customerName (+31 more)

### Community 12 - "Models"
Cohesion: 0.04
Nodes (46): BillItemModel, DailySalesModel, StockMovementModel, averageBill, billCount, BillItem, changeType, copyWith (+38 more)
...
Cohesion: 0.14
Nodes (23): add_edit_category_dialog.dart, Bloc, core/theme/app_theme.dart, AddCategory, CategoryEvent, DeleteCategory, LoadCategories, UpdateCategory (+15 more)
...
Cohesion: 0.10
Nodes (19): ../bloc/category_bloc.dart, ../../../../core/utils/app_validators.dart, ../../domain/entities/category.dart, CategoryModel, fromEntity, fromJson, toEntity, toJson (+11 more)
...
Cohesion: 0.10
Nodes (20): LoadBillHistory, BillHistoryPage, _BillHistoryPageState, build, _buildBillCard, createState, _datePickerButton, dispose (+12 more)
...
### Community 64 - "Domain"
Cohesion: 0.17
Nodes (14): AppDrawer, AuthEvent, email, GoogleLoginRequested, LogoutRequested, name, password, props (+6 more)
...
Cohesion: 0.21
Nodes (21): _DashboardViewState, ReportBloc, DeleteBill, LoadBillDetail, LoadDailySales, LoadLowStockProducts, LoadSalesRange, LoadStockMovements (+13 more)
...
Cohesion: 0.22
Nodes (9): HomePage, _DashboardView, AddProductPage, BillDetailPage, DailySalesPage, LowStockPage, StockMovementPage, ShopDetailsPage (+1 more)
...
## Knowledge Gaps
- **1066 isolated node(s):** `supabase`, `XCTest`, `_sub`, `rootNavigatorKey`, `dispose` (+1061 more)
...
- **Why does `AuthBloc` connect `Implementation` to `Presentation`, `Utils`, `Presentation`, `Presentation`, `Presentation`, `Domain`, `Presentation`, `Entities`, `Presentation`, `Presentation`, `Presentation`, `Domain`, `Widgets`, `App`, `Repositories`, `Domain`, `Domain`, `Presentation`, `Database`, `Presentation`, `Domain`, `Domain`, `Community 89`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `ReportBloc` connect `Community 89` to `Presentation`, `Presentation`, `Repositories`, `Domain`, `Presentation`, `Models`, `Presentation`, `Presentation`, `Domain`, `Widgets`, `App`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `Product` connect `Repositories` to `Presentation`, `Presentation`, `Launchimage`, `Presentation`, `Usecases`, `Presentation`, `Presentation`, `Presentation`?**

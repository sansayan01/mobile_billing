# Graph Report - flutter_billing_app-main  (2026-08-24)

## Corpus Check
- 336 files · ~1,693,074 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5488 nodes · 7864 edges · 353 communities (324 shown, 29 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 46 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `42e8c8a3`
...
1. `Memory — Session Log & Context` - 75 edges
2. `AuthBloc` - 70 edges
3. `TailwindConfigGenerator` - 58 edges
4. `ReportBloc` - 55 edges
5. `DesignSystemGenerator` - 48 edges
6. `ProductBloc` - 48 edges
7. `search()` - 46 edges
8. `BillingBloc` - 40 edges
...
Cohesion: 0.03
Nodes (71): address1, address2, barcode, billId, cartItems, copyWith, customer, customPrice (+63 more)

### Community 1 - "warranty_bloc.dart"
Cohesion: 0.07
Nodes (29): billId, claimId, claimReason, claims, claimType, copyWith, customerName, customerPhone (+21 more)

### Community 2 - "shop_details_page.dart"
Cohesion: 0.06
Nodes (49): Bloc, ../bloc/shop_bloc.dart, ../../../../core/usecase/usecase.dart, LoadShopEvent, message, ShopError, ShopEvent, ShopInitial (+41 more)

### Community 3 - "audit_repository.dart"
Cohesion: 0.29
Nodes (6): AuditRepositoryImpl, AuditRepository, getAuditLogs, getEntityAuditLogs, logAction, package:billing_app/features/audit/domain/entities/audit_log.dart
...
Cohesion: 0.15
Nodes (22): _onConnect, _onDisconnect, _onInit, _onRefresh, _onScan, _onTestPrint, PrinterBloc, repository (+14 more)

### Community 6 - "dashboard_page.dart"
Cohesion: 0.06
Nodes (41): appBarTheme, buildActions, _buildDescriptionSnippet, buildLeading, _buildLoadingPlaceholder, buildResults, _buildSearchResults, buildSuggestions (+33 more)

### Community 7 - "bill_history_page.dart"
Cohesion: 0.04
Nodes (48): CustomPainter, _SalesTrendPainter, _applyDateRange, _buildBillCard, _buildBillComparison, _buildPaymentPieChart, _buildPaymentStatusBadge, _buildQuickDateFilters (+40 more)

### Community 8 - "app_routes.dart"
Cohesion: 0.04
Nodes (46): app_shell.dart, ChangeNotifier, ../../features/audit/presentation/bloc/audit_bloc.dart, ../../features/audit/presentation/bloc/audit_event.dart, ../../features/audit/presentation/pages/audit_timeline_page.dart, ../../features/auth/presentation/pages/email_verification_page.dart, ../../features/auth/presentation/pages/login_page.dart, ../../features/auth/presentation/pages/register_page.dart (+38 more)

### Community 9 - "report_bloc.dart"
Cohesion: 0.06
...
Cohesion: 0.05
Nodes (42): ../../../../core/utils/csv_export_import.dart, allProducts, build, _buildDescriptionSnippet, _buildFab, _buildProductTile, _buildStatsBar, categories (+34 more)

### Community 12 - "due_payments_bloc.dart"
Cohesion: 0.06
Nodes (47): amount, billId, CollectPayment, copyWith, duePayments, DuePaymentsEvent, DuePaymentsState, error (+39 more)
...
### Community 16 - "damaged_products_bloc.dart"
Cohesion: 0.07
...
Cohesion: 0.07
Nodes (30): _actionBtn, _allDialKey, _badge, _bottomPanel, build, categoryName, categoryNames, child (+22 more)
...
### Community 19 - "bill_detail_page.dart"
Cohesion: 0.07
Nodes (28): _actionBtn, bill, build, _buildCustomerHistory, _buildInfoCard, _buildPaymentStatusRow, _buildPaymentTimeline, _confirmDelete (+20 more)
...
### Community 23 - "edit_product_page.dart"
Cohesion: 0.07
Nodes (29): ../bloc/product_bloc.dart, ../../../../core/utils/image_compress.dart, File?, _barcodeController, build, _categoryId, createState, _description (+21 more)

### Community 24 - "gray"
Cohesion: 0.05
Nodes (53): $type, $value, $type, $value, $type, $value, $type, $value (+45 more)

### Community 25 - "warranty_claims_page.dart"
Cohesion: 0.10
Nodes (20): ../bloc/warranty_bloc.dart, core/service_locator.dart, ReportRepositoryImpl, ReportRepository, _buildClaimCard, _buildTypeFilterChip, createState, _detailRow (+12 more)

### Community 26 - "product_model.dart"
Cohesion: 0.07
Nodes (26): hashCode, operator, read, typeId, write, barcode, categoryId, createdAt (+18 more)

### Community 27 - "low_stock_page.dart"
Cohesion: 0.08
Nodes (23): _animatedCount, _animController, _applyThreshold, build, _buildCategoryChips, _buildEmptyState, _buildFilterSection, _buildProductCard (+15 more)

### Community 28 - "stock_bloc.dart"
Cohesion: 0.12
Nodes (22): adjustments, AdjustStock, copyWith, LoadAllAdjustments, LoadStockHistory, message, note, productId (+14 more)

### Community 29 - "home_page.dart"
Cohesion: 0.08
...
### Community 32 - "category_bloc.dart"
Cohesion: 0.07
...
### Community 34 - "add_product_page.dart"
Cohesion: 0.07
Nodes (29): ../../../category/domain/entities/category.dart, ../../../../core/utils/image_upload_service.dart, AddProductPage, _AddProductPageState, _barcodeController, build, _categoryController, _categoryId (+21 more)

### Community 35 - "checkout_page.dart"
Cohesion: 0.11
Nodes (18): ../bloc/billing_bloc.dart, ../../../customer/domain/entities/customer.dart, ../../../customer/presentation/bloc/customer_bloc.dart, ../../domain/entities/cart_item.dart, createState, _customerNameController, _customerPhoneController, dispose (+10 more)
...
Cohesion: 0.07
Nodes (28): app_typography.dart, aiGradient, AppTheme, backgroundColor, _baseInputTheme, darkBackground, darkBorder, darkCard (+20 more)
...
### Community 41 - "warranty_repository_impl.dart"
Cohesion: 0.13
Nodes (14): ../../../../core/error/failure.dart, ../../domain/entities/warranty_claim.dart, ../../domain/repositories/warranty_repository.dart, createClaim, _fromMap, getClaims, _resolveShopId, _supabase (+6 more)

### Community 42 - "ProductBloc"
Cohesion: 0.12
Nodes (28): AddProduct, DeleteProduct, FilterByCategory, GenerateQrCode, InitRealtime, ProductEvent, ProductsRealtimeUpdated, UpdateProduct (+20 more)

### Community 43 - "ReportBloc"
Cohesion: 0.08
Nodes (50): CheckoutPage, HomePage, _DashboardView, _DashboardViewState, ProductCoverflowSkeleton, _ProductCoverflowSkeletonState, ProductListPage, ReportBloc (+42 more)
...
### Community 48 - "damaged_products_page.dart"
Cohesion: 0.13
Nodes (14): _buildBadge, _buildDamagedProductsList, _buildEmptyState, _buildImagePlaceholder, _buildProductImage, _buildSummaryCard, createState, DamagedProductsPage (+6 more)

### Community 49 - "recent_transactions_card.dart"
Cohesion: 0.11
...
### Community 51 - "add_edit_category_dialog.dart"
Cohesion: 0.08
...
### Community 59 - "product_detail_page.dart"
Cohesion: 0.09
...
### Community 60 - "monthly_trend_card.dart"
Cohesion: 0.12
...
Cohesion: 0.10
Nodes (20): Future, Customer, _billsFuture, build, _buildBillsSection, _buildDueBalanceSection, _buildSectionTitle, _buildWarrantySection (+12 more)

### Community 63 - "app_typography.dart"
Cohesion: 0.11
Nodes (18): AppTypography, bodyLarge, bodyMedium, bodySmall, displayLarge, displaySmall, fontFamily, headlineLarge (+10 more)
...
Cohesion: 0.07
Nodes (27): BillItemModel, BillSummaryModel, DailySalesModel, fromJson, fromSupabaseRow, StockMovementModel, toJson, BillItem (+19 more)
...
### Community 67 - "package:intl/intl.dart"
Cohesion: 0.08
Nodes (23): dart:io, ../../features/damaged_products/domain/entities/damaged_product.dart, ../../../../features/product/domain/entities/product.dart, CsvExportImport, exportDamagedProducts, exportProducts, importProducts, compressImage (+15 more)

### Community 68 - "BM25"
Cohesion: 0.16
Nodes (5): BM25, BM25 ranking algorithm for text search, TestBm25CoreBehavior, TestDiagnosticsContracts, TestTokenizer

### Community 69 - "generate_design_system"
Cohesion: 0.25
...
### Community 70 - "auth_repository_impl.dart"
Cohesion: 0.13
...
### Community 71 - "Equatable"
Cohesion: 0.08
Nodes (29): BillingState, DamagedProductsState, ProductState, Equatable, BillDetailParams, BillHistoryParams, billId, call (+21 more)

### Community 72 - ".application"
Cohesion: 0.15
Nodes (10): Bool, Flutter, FlutterAppDelegate, AppDelegate, Any, RunnerTests, UIApplication, UIKit (+2 more)

### Community 73 - "scanner_page.dart"
Cohesion: 0.10
...
### Community 80 - "report_repository_impl.dart"
Cohesion: 0.14
...
### Community 81 - "product_repository_impl.dart"
Cohesion: 0.08
Nodes (26): core/data/hive_database.dart, core/supabase/supabase_client.dart, ../../domain/repositories/product_repository.dart, ../../domain/repositories/shop_repository.dart, _, DeepLinkConfig, emailRedirectTo, host (+18 more)

### Community 82 - "stock_adjustment.dart"
Cohesion: 0.09
Nodes (21): bool get, _channels, dispose, _isConnected, RealtimeService, subscribeToProducts, subscribeToTable, unsubscribe (+13 more)

### Community 83 - "audit_bloc.dart"
Cohesion: 0.15
...
### Community 86 - "Route /"
Cohesion: 0.17
Nodes (12): build, build, build, build, build, build, build, Route / (+4 more)

### Community 87 - "category_list_page.dart"
Cohesion: 0.08
Nodes (23): add_edit_category_dialog.dart, _buildEmptySearch, _buildEmptyState, _buildStatsCard, _categoryCard, _confirmSwipeDelete, createState, dispose (+15 more)

### Community 88 - "Current Session: 2026-07-21 — Receipt Preview + WhatsApp Share ✅"
Cohesion: 0.67
...
### Community 91 - "WarrantyBloc"
Cohesion: 0.33
Nodes (12): CreateWarrantyClaim, LoadWarrantyClaims, UpdateWarrantyClaimStatus, WarrantyEvent, WarrantyState, WarrantyBloc, build, _buildFilterChip (+4 more)

### Community 92 - "parse_decision_rules"
Cohesion: 0.31
...
### Community 93 - "category_repository_impl.dart"
Cohesion: 0.20
...
### Community 94 - "List"
Cohesion: 0.09
Nodes (23): DateTime, CacheFailure, Failure, message, props, ServerFailure, colorValue, copyWith (+15 more)

### Community 95 - "app_bottom_nav.dart"
Cohesion: 0.09
Nodes (20): active, AppBottomNav, _BillingButton, build, currentRoute, _go, icon, _isActive (+12 more)

### Community 96 - "test_design_system_mode.py"
Cohesion: 0.16
...
### Community 97 - "app_skeleton.dart"
Cohesion: 0.12
Nodes (16): Animation, AnimationController, AppSkeleton, AppSkeletonList, AppSkeletonListTile, _AppSkeletonState, build, _controller (+8 more)

### Community 98 - "Canvas Design System"
Cohesion: 0.06
Nodes (35): 1. Visual Communication First, 2. Minimal Text Integration, 3. Expert Craftsmanship, 4. Systematic Patterns, Analog Meditation, Approach, Canvas Boundaries, Canvas Design System (+27 more)

### Community 99 - "package:fpdart/fpdart.dart"
Cohesion: 0.07
Nodes (26): ../error/failure.dart, call, NoParams, collectPayment, getBillForDuePayment, getDuePayments, getTotalPendingDue, deleteBill (+18 more)

### Community 100 - "manifest.json"
Cohesion: 0.18
Nodes (10): background_color, description, display, icons, name, orientation, prefer_related_applications, short_name (+2 more)

### Community 101 - "AuthBloc"
Cohesion: 0.15
Nodes (24): AppDrawer, AuthBloc, AuthEvent, CheckAuthStatus, email, GoogleLoginRequested, LoginRequested, LogoutRequested (+16 more)
...
### Community 103 - "Current Session: 2026-08-21 — Product Page: Remove Redundant Add Button ✅"
Cohesion: 0.67
Nodes (3): Change, Current Session: 2026-08-21 — Product Page: Remove Redundant Add Button ✅, Verify

### Community 104 - "glass_card.dart"
Cohesion: 0.08
Nodes (22): ../../core/widgets/app_bottom_nav.dart, ../../core/widgets/app_drawer.dart, dart:ui, double?, AppShell, build, child, _fullScreenRoutes (+14 more)
...
Cohesion: 0.05
Nodes (41): BUG FIX 7: 2026-08-21 back button black screen on Due Payments / Damaged / Customers, Current Session: 2026-07-18 — Product Card Tap + Description Copy + Extra Fields ✅, Current Session: 2026-07-18 — Product Detail Page + Dashboard Search Navigation ✅, Current Session: 2026-07-21 — Billing History Section Audit + Warnings Fix ✅, Current Session: 2026-07-21 — Cleaned up Flutter Analyzer Linter Suggestions ✅, Current Session: 2026-07-21 — Fixed Category "All" Selection Not Clearing ✅, Current Session: 2026-07-21 — Fixed Category Chip Highlight State Sync ✅, Current Session: 2026-07-21 — Layout + Routing Fixes ✅ (+33 more)
...
### Community 109 - "email_verification_page.dart"
Cohesion: 0.17
Nodes (12): dart:async, createState, dispose, email, EmailVerificationPage, _EmailVerificationPageState, _isChecking, _isResending (+4 more)
...
### Community 111 - "design_system.py"
Cohesion: 0.11
...
### Community 112 - "damaged_products_repository_impl.dart"
Cohesion: 0.05
Nodes (39): ../../../auth/data/models/user_model.dart, ../../../auth/domain/entities/user.dart, ../../domain/repositories/staff_repository.dart, _anonKey, client, initialize, SupabaseConfig, _url (+31 more)
...
Cohesion: 0.12
Nodes (23): copyWith, DeleteStaffMember, id, LoadStaff, message, staff, StaffEvent, StaffState (+15 more)
...
### Community 126 - "Current Session: 2026-08-21 — Billing Scanner Beep Sound Missing ✅"
Cohesion: 0.40
Nodes (5): Current Session: 2026-08-21 — Billing Scanner Beep Sound Missing ✅, Fix, Problem (user reported), Root Cause, Verify

### Community 127 - "AGENTS.md — Flutter Billing App"
Cohesion: 0.13
...
### Community 129 - "CLAUDE.md — Flutter Billing App"
Cohesion: 0.13
...
### Community 131 - "printer_repository_impl.dart"
Cohesion: 0.15
...
### Community 136 - "Implementation Plan — Flutter Billing App (Next Phase)"
Cohesion: 0.22
...
### Community 137 - "RPD — Requirements & Product Definition"
Cohesion: 0.20
Nodes (10): 11. Customer CMS (Minimal) — PLANNED, Client Profile, Constraints, Product Overview, Role Assignment Flow, RPD — Requirements & Product Definition, Shop Isolation Implementation, Target Platforms (+2 more)

### Community 139 - "Current Session: 2026-07-23 — Full Dark Mode Implementation 🎨🌙"
Cohesion: 0.25
...
### Community 140 - "category_usecases.dart"
Cohesion: 0.13
...
### Community 141 - "Tailwind CSS Responsive Design"
Cohesion: 0.06
Nodes (32): 1. Mobile-First Design, 2. Consistent Breakpoint Usage, 3. Test at Breakpoint Boundaries, 4. Use Container for Content Width, 5. Progressive Enhancement, 6. Avoid Too Many Breakpoints, Best Practices, Breakpoint System (+24 more)

### Community 142 - "Current Session: 2026-07-22 — Bill Edit/Delete + Manual Product Entry ✅"
Cohesion: 0.33
...
### Community 143 - "Current Session: 2026-07-22 — Logout Infinite Loop Fix ✅"
Cohesion: 0.33
...
### Community 144 - "Current Session: 2026-07-24 — Advanced Dashboard Analytics (fl_chart + 4 new widgets) ✅"
Cohesion: 0.40
...
### Community 145 - "Current Session: 2026-07-22 — Full Bill Edit Feature ✅"
Cohesion: 0.40
...
### Community 146 - "Previous: 2026-08-20 — Product Page UI Upgrade v2 (Spotlight Cover-flow) 🎡"
Cohesion: 0.40
...
### Community 147 - "Current Session: 2026-07-21 — Shop Persistence Fix + Final Cleanup ✅"
Cohesion: 0.40
...
### Community 148 - "Current Session: 2026-07-23 — Stock Decrease/Increase Logic Audit + Realtime ✅"
Cohesion: 0.40
...
### Community 149 - "Current Session: 2026-07-21 — Shop Isolation Audit & Fix ✅"
Cohesion: 0.50
...
### Community 151 - "Current Session: 2026-07-21 — Customer Info on Checkout Page ✅"
Cohesion: 0.50
Nodes (4): Current Session: 2026-07-21 — Customer Info on Checkout Page ✅, DB Migration, flutter analyze, What Was Done

### Community 152 - "Current Session: 2026-07-21 — Edit Page Barcode Editable + AppBar Fix ✅"
Cohesion: 0.50
Nodes (4): Current Session: 2026-07-21 — Edit Page Barcode Editable + AppBar Fix ✅, flutter analyze, flutter analyze, What Was Done

### Community 153 - "Current Session: 2026-07-22 — Stock Revert Bug Fix (deleteBill + updateBill) ✅"
Cohesion: 0.50
...
### Community 155 - "Current Session: 2026-07-22 — Bill Delete Stock Restoration Fix ✅"
Cohesion: 0.50
Nodes (4): Current Session: 2026-07-22 — Bill Delete Stock Restoration Fix ✅, Files Modified, flutter analyze, What Was Done

### Community 156 - "Current Session: 2026-07-22 — Complete Navigation Fix ✅"
Cohesion: 0.50
Nodes (4): Current Session: 2026-07-22 — Complete Navigation Fix ✅, flutter analyze, Next, What Was Done

### Community 157 - "package:flutter_bloc/flutter_bloc.dart"
Cohesion: 0.09
Nodes (24): _loadThemeMode, setThemeMode, toggleTheme, AddCustomerPage, _AddCustomerPageState, build, createState, dispose (+16 more)

### Community 158 - "Current Session: 2026-07-23 — Dark Mode: Auth/Category/Report/Shop/Staff Pages ✅"
Cohesion: 0.50
...
### Community 164 - "BUG FIX 5: 2026-08-21 - card tap crash (Spacer in fixed-height bottom sheet)"
Cohesion: 0.33
Nodes (6): BUG FIX 5: 2026-08-21 - card tap crash (Spacer in fixed-height bottom sheet), Fix, Lesson, Root cause, Symptom, Verify

### Community 165 - "package:go_router/go_router.dart"
Cohesion: 0.12
Nodes (15): IconData?, AppBackButton, icon, size, currentRoute, _DrawerItem, icon, _initials (+7 more)
...
### Community 167 - "Current Session: 2026-08-21 — Checkout Dialog: Scanner Add Broken ✅"
Cohesion: 0.40
...
### Community 168 - "Logo Usage Rules"
Cohesion: 0.07
...
### Community 171 - "shadcn/ui Accessibility Patterns"
Cohesion: 0.07
...
### Community 172 - "Feature: 2026-08-21 - Auto bill-id QR on every receipt"
Cohesion: 0.40
Nodes (5): Feature: 2026-08-21 - Auto bill-id QR on every receipt, Fix, Remaining, Verify, What

### Community 173 - "TestTailwindConfigGenerator"
Cohesion: 0.07
...
### Community 174 - "BUG FIX 6: 2026-08-21 - warranty back button black screen"
Cohesion: 0.33
...
### Community 178 - "Design"
Cohesion: 0.33
Nodes (6): Design, Layout Considerations, Navigation Pattern, Screens, Theme — Liquid Glass + Dark Mode, Typography
...
### Community 184 - "BUG FIX 8: 2026-08-24 - AddProductPage category select crash (type mismatch)"
Cohesion: 0.40
...
### Community 186 - "Asset Approval Checklist"
Cohesion: 0.08
...
### Community 187 - "Fix: 2026-08-21 - Receipt due/payment not showing"
Cohesion: 0.50
Nodes (4): Fix, Fix: 2026-08-21 - Receipt due/payment not showing, Remaining, Root Cause

### Community 188 - "Logo AI Prompt Engineering"
Cohesion: 0.08
Nodes (25): Common Pitfalls, Core Prompt Structure, Detailed Brief, Eco/Sustainable, Effective Keywords by Style, Fashion Brand, Healthcare, Industry-Specific Prompts (+17 more)

### Community 189 - "DesignSystemGenerator"
Cohesion: 0.13
...
### Community 190 - "phone_utils.dart"
Cohesion: 0.33
Nodes (5): cleaned, isValidPhone, normalized, normalizePhone, return

### Community 191 - "Current Session: 2026-08-21 - Customer CMS FEATURE BUILT (needs device verify)"
Cohesion: 0.50
...
### Community 192 - "CHANGE: 2026-08-21 - Manual warranty entry REMOVED (scan-only)"
Cohesion: 0.40
Nodes (5): CHANGE: 2026-08-21 - Manual warranty entry REMOVED (scan-only), Result, Verify, What, Why

### Community 193 - "Current Session: 2026-07-21 — Description Search on Product Management Page ✅"
Cohesion: 0.67
Nodes (3): Current Session: 2026-07-21 — Description Search on Product Management Page ✅, flutter analyze, What Was Done

### Community 194 - "DESIGN FIX: 2026-08-24 - Reports Home page redesign"
Cohesion: 0.40
Nodes (5): DESIGN FIX: 2026-08-24 - Reports Home page redesign, Fix, Lesson, Symptom, Verify

### Community 195 - "BUG FIX 4: 2026-08-21 - card tap crash (Scaffold wrapped in Stack)"
Cohesion: 0.33
Nodes (6): BUG FIX 4: 2026-08-21 - card tap crash (Scaffold wrapped in Stack), Fix, Lesson, Root cause, Symptom, Verify

### Community 196 - "package:billing_app/core/theme/app_theme.dart"
Cohesion: 0.14
Nodes (13): build, GreetingHeader, _monthName, userName, build, color, icon, label (+5 more)

### Community 197 - "Previous: 2026-08-20 — Product Page UI Upgrade (Bento Inventory) 🎨"
Cohesion: 0.67
Nodes (3): flutter analyze, Previous: 2026-08-20 — Product Page UI Upgrade (Bento Inventory) 🎨, What Was Done

### Community 198 - "auth_repository.dart"
Cohesion: 0.20
...
### Community 200 - "stock_repository_impl.dart"
Cohesion: 0.12
Nodes (15): ../../domain/entities/stock_adjustment.dart, ../../domain/repositories/stock_repository.dart, ../entities/stock_adjustment.dart, adjustStock, _fromMap, getAllAdjustments, getStockHistory, _resolveShopId (+7 more)

### Community 201 - "Color Palette Management"
Cohesion: 0.08
...
### Community 205 - "Current Session: 2026-07-22 — Staff Widget Owner-Only (Dashboard + Drawer + Route Guard) ✅"
Cohesion: 0.67
...
### Community 207 - "States and Variants"
Cohesion: 0.08
...
### Community 208 - "Current Session: 2026-07-22 — Navigation Fix v2: PopScope + addPostFrameCallback ✅"
Cohesion: 0.67
...
### Community 212 - "staff_list_page.dart"
Cohesion: 0.14
Nodes (13): ../bloc/staff_bloc.dart, ../../../../core/widgets/app_feedback.dart, ../../../../core/widgets/app_skeleton.dart, ../../../../features/auth/domain/entities/user.dart, features/auth/presentation/bloc/auth_bloc.dart, ../../../../features/auth/presentation/bloc/auth_state.dart, build, createState (+5 more)

### Community 213 - "Tailwind CSS Customization"
Cohesion: 0.09
Nodes (22): @apply Directive, Best Practices, Color Customization, Complete Tailwind Config, Configuration Examples, Content Configuration, Custom Color Palette, Custom Font Sizes (+14 more)

### Community 214 - "Previous Session: 2026-08-19 — Due Payments Management Feature ✅"
Cohesion: 0.67
Nodes (3): Files Created/Modified, Previous Session: 2026-08-19 — Due Payments Management Feature ✅, What Was Done

### Community 215 - "spacing"
Cohesion: 0.09
Nodes (22): $type, $value, $type, $value, $type, $value, $type, $value (+14 more)

### Community 216 - "_suggest_identities"
Cohesion: 0.25
...
### Community 219 - "Routing by Task Type"
Cohesion: 0.10
...
### Community 220 - "generate-slide.py"
Cohesion: 0.15
...
### Community 222 - "TailwindConfigGenerator"
Cohesion: 0.10
...
### Community 227 - "build"
Cohesion: 0.33
Nodes (10): build, _buildQuickTiles, Route /categories, Route /customers, Route /damaged-products, Route /due-payments, Route /settings, Route /shop (+2 more)

### Community 228 - "Brand Consistency Checklist"
Cohesion: 0.11
Nodes (17): Audit Frequency, Brand Consistency Checklist, Channel Audit, Collateral, Colors, Common Issues, Email, Imagery (+9 more)

### Community 229 - "CIP Mockup Prompt Engineering"
Cohesion: 0.11
...
### Community 231 - "fetch-background.py"
Cohesion: 0.17
Nodes (17): generate_css_for_background(), get_background_image(), get_curated_images(), get_overlay_css(), get_pexels_search_url(), load_backgrounds_config(), load_brand_colors(), main() (+9 more)

### Community 232 - "TestShadcnInstaller"
Cohesion: 0.12
Nodes (10): fixture, Test adding components without shadcn config., Test ShadcnInstaller class., Test adding all components without config., Test adding all components in dry run mode., Create temporary project structure., Test listing installed components without config., Test initialization with default project root. (+2 more)

### Community 233 - "TestThresholdGate"
Cohesion: 0.13
Nodes (3): TestFixtureValidation, TestMetricMath, TestThresholdGate

### Community 234 - "Design Principles"
Cohesion: 0.12
...
### Community 235 - "Design Principles"
Cohesion: 0.12
Nodes (15): 22 Art Direction Styles, Banner Sizes & Art Direction Styles Reference, Complete Banner Sizes, CTA Rules, Design Principles, Pinterest Research Queries, Print, Print Specs (+7 more)

### Community 236 - "icon/generate.py"
Cohesion: 0.20
...
### Community 239 - "CIP Design Reference"
Cohesion: 0.13
...
### Community 240 - "Icon Design Reference"
Cohesion: 0.13
...
### Community 241 - "Copywriting Formulas"
Cohesion: 0.13
...
### Community 249 - "Banner Design - Multi-Format Creative Banner System"
Cohesion: 0.14
...
### Community 250 - "Messaging Framework"
Cohesion: 0.14
...
### Community 251 - "Brand Voice Framework"
Cohesion: 0.14
...
### Community 252 - "extract-colors.cjs"
Cohesion: 0.22
Nodes (11): calculateCompliance(), colorDistance(), displayPalette(), extractHexColors(), findNearestBrandColor(), fs, generateImageMagickCommand(), hexToRgb() (+3 more)

### Community 253 - "validate-asset.cjs"
Cohesion: 0.25
Nodes (13): checkManifest(), formatBytes(), formatOutput(), fs, main(), parseFilename(), path, RULES (+5 more)

### Community 254 - "Layout Patterns"
Cohesion: 0.14
Nodes (13): Card Styles, Component Variants, CSS Structures, Feature Grid (3 columns), Layout Decision Flow, Layout Patterns, Layout Selection by Use Case, Metric Styles (+5 more)

### Community 255 - "Tailwind Integration"
Cohesion: 0.14
...
### Community 256 - "Layout Patterns"
Cohesion: 0.14
Nodes (13): Card Styles, Component Variants, CSS Structures, Feature Grid (3 columns), Layout Decision Flow, Layout Patterns, Layout Selection by Use Case, Metric Styles (+5 more)

### Community 257 - "update.md"
Cohesion: 0.15
...
### Community 258 - "Logo Design Reference"
Cohesion: 0.15
...
### Community 259 - "Token Architecture"
Cohesion: 0.15
...
### Community 260 - "design-tokens-starter.json"
Cohesion: 0.15
...
Cohesion: 0.14
Nodes (14): build, _buildQuantityButton, createState, currentStock, _damageTypes, dispose, MarkDamagedDialog, _MarkDamagedDialogState (+6 more)
...
### Community 264 - "validate-tokens.cjs"
Cohesion: 0.24
...
### Community 266 - "login_page.dart"
Cohesion: 0.12
Nodes (17): FormState, authenticatedChild, SplashScreen, createState, dispose, _emailController, _formKey, _isLoading (+9 more)

### Community 267 - "ShadcnInstaller"
Cohesion: 0.18
Nodes (7): Path, Handle shadcn/ui component installation., Initialize installer. Args: project_root: Project root directory (default:…, ShadcnInstaller, Tests for shadcn_add.py, Test initialization with custom project root., Test getting installed components when files exist.

### Community 268 - ".add_components"
Cohesion: 0.22
...
### Community 273 - "inject-brand-context.cjs"
Cohesion: 0.31
Nodes (10): extractColorsFromTable(), extractCoreAttributes(), extractHexColors(), extractImageStyle(), extractTypography(), extractVoice(), fs, generatePromptAddition() (+2 more)

### Community 274 - "CIP Design Style Guide"
Cohesion: 0.18
Nodes (10): Bold Dynamic, CIP Design Style Guide, Classic Traditional, Color Psychology, Corporate Minimal, Fresh Modern, Luxury Premium, Modern Tech (+2 more)

### Community 275 - "embed-tokens.cjs"
Cohesion: 0.20
...
### Community 279 - "inventory_health_card.dart"
Cohesion: 0.10
Nodes (18): Color, build, _buildGlassContainer, color, count, InventoryHealthCard, label, lowStockCount (+10 more)

### Community 280 - "Component Tokens"
Cohesion: 0.20
...
### Community 281 - "generate-tokens.cjs"
Cohesion: 0.36
Nodes (9): flattenTokens(), fs, generateCSS(), generateTailwind(), main(), parseArgs(), path, resolveReference() (+1 more)

### Community 282 - "button"
Cohesion: 0.20
Nodes (10): fg, font-size, hover-bg, button, $type, $value, $type, $value (+2 more)

### Community 283 - "duration"
Cohesion: 0.20
Nodes (10): fast, normal, slow, $type, $value, $type, $value, duration (+2 more)

### Community 284 - "Slide Strategies"
Cohesion: 0.20
Nodes (9): Common Structures, Duarte Sparkline Pattern, Matching Strategy to Context, Product Demo (6 slides), Sales Pitch (9 slides), Search Commands, Slide Strategies, Strategy Selection (+1 more)

### Community 285 - "._base_config"
Cohesion: 0.22
...
### Community 286 - "test_text_layout_resilience.py"
Cohesion: 0.22
...
### Community 288 - "auth_bloc.dart"
Cohesion: 0.05
Nodes (48): fromJson, fromProfileJson, fromSupabaseAuth, toJson, AuthRepositoryImpl, AuthRepository, call, GetCurrentUserUseCase (+40 more)

### Community 289 - "sync-brand-to-tokens.cjs"
Cohesion: 0.33
Nodes (8): adjustBrightness(), { execFileSync }, extractColorsFromMarkdown(), fs, generateColorScale(), main(), path, updateDesignTokens()

### Community 290 - "Current Session: 2026-07-21 — Edit Page Barcode Editable + Scanner Back Button ✅"
Cohesion: 0.67
...
### Community 293 - "HTML Slide Template"
Cohesion: 0.29
Nodes (6): Animation Classes, Background Images, Base Structure, Chart.js Integration, CSS Variables Reference, HTML Slide Template

### Community 294 - "HTML Slide Template"
Cohesion: 0.29
Nodes (6): Animation Classes, Background Images, Base Structure, Chart.js Integration, CSS Variables Reference, HTML Slide Template

### Community 295 - "Slides"
Cohesion: 0.33
...
### Community 306 - "DamagedProductsBloc"
Cohesion: 0.38
...
### Community 313 - "secondary-foreground"
Cohesion: 0.67
...
### Community 317 - "padding-y"
Cohesion: 0.67
Nodes (4): padding-y, padding-y, $type, $value

### Community 318 - "build"
Cohesion: 0.29
Nodes (8): build, build, Route /reports/audit-trail, Route /reports/bills, Route /reports/daily-sales, Route /reports/low-stock, Route /reports/stock-movements, Route /scan

### Community 319 - "ring"
Cohesion: 0.67
Nodes (3): ring, $type, $value

### Community 320 - "damaged_products_repository.dart"
Cohesion: 0.22
Nodes (8): DamagedProductsRepositoryImpl, DamagedProductsRepository, getDamagedProducts, getDamagedProductsCount, getTotalDamageLoss, markAsDamaged, undoDamage, package:billing_app/features/damaged_products/domain/entities/damaged_product.dart

### Community 325 - "warranty_usecases.dart"
Cohesion: 0.25
Nodes (7): ../entities/warranty_claim.dart, call, CreateWarrantyClaimUseCase, GetWarrantyClaimsUseCase, repository, UpdateClaimStatusUseCase, ../repositories/warranty_repository.dart

### Community 326 - "ProductModel"
Cohesion: 0.33
Nodes (7): @HiveType, ProductModelAdapter, ShopModelAdapter, ProductModel, ShopModel, Shop, TypeAdapter

### Community 331 - "_ProductListPageState"
Cohesion: 0.43
Nodes (7): MarkProductAsDamaged, LoadProducts, ProductDetailPage, _ProductDetailPageState, _showMarkDamagedDialog, _ProductListPageState, _showMarkDamagedDialog

### Community 342 - "Current Session: 2026-07-21 — Description Match Snippet Highlight on Search ✅"
Cohesion: 0.67
Nodes (3): Current Session: 2026-07-21 — Description Match Snippet Highlight on Search ✅, flutter analyze, What Was Done

### Community 343 - "Current Session: 2026-07-21 — Fixed Category Switch Animation Glitch ✅"
Cohesion: 0.67
Nodes (3): Current Session: 2026-07-21 — Fixed Category Switch Animation Glitch ✅, flutter analyze, What Was Done

### Community 344 - "Current Session: 2026-07-21 — Ultra-Compact Product Cards + Alignment Fix ✅"
Cohesion: 0.67
Nodes (3): Current Session: 2026-07-21 — Ultra-Compact Product Cards + Alignment Fix ✅, flutter analyze, What Was Done

### Community 345 - "destructive"
Cohesion: 0.67
Nodes (3): destructive, $type, $value

### Community 346 - "Current Session: 2026-07-28 — README.md Update ✅"
Cohesion: 0.67
Nodes (3): Current Session: 2026-07-28 — README.md Update ✅, What Was Done, What Was NOT Changed

### Community 347 - "Previous Session: 2026-08-20 — Report Pages Modernization 📊✨"
Cohesion: 0.67
...
## Knowledge Gaps
- **3042 isolated node(s):** `supabase`, `fs`, `path`, `fs`, `path` (+3037 more)
...
- **Why does `search()` connect `search` to `.generate`, `detect_domain`, `BM25`, `generate_design_system`, `.tokenize`, `design_system.py`, `validate_data.py`, `scripts/core.py`, `_suggest_identities`, `test_text_layout_resilience.py`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `AuthBloc` connect `AuthBloc` to `billing_bloc.dart`, `warranty_bloc.dart`, `shop_details_page.dart`, `dashboard_page.dart`, `app_routes.dart`, `report_bloc.dart`, `login_page.dart`, `due_payments_bloc.dart`, `product_bloc.dart`, `damaged_products_bloc.dart`, `bill_detail_page.dart`, `stock_bloc.dart`, `home_page.dart`, `BillingBloc`, `auth_bloc.dart`, `category_bloc.dart`, `checkout_page.dart`, `package:go_router/go_router.dart`, `ReportBloc`, `main.dart`, `add_staff_page.dart`, `customer_bloc.dart`, `auth_state.dart`, `register_page.dart`, `audit_bloc.dart`, `staff_list_page.dart`, `Route /`, `settings_page.dart`, `build`, `email_verification_page.dart`, `staff_bloc.dart`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `DesignSystemGenerator` connect `DesignSystemGenerator` to `test_design_system_mode.py`, `.generate`, `detect_domain`, `BM25`, `generate_design_system`, `read_rows`, `design_system.py`, `search`, `_style_is_dark_primary`, `TestGeneratedCatalogContract`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Are the 2 inferred relationships involving `TailwindConfigGenerator` (e.g. with `TestGeneratedConfigIsValidJs` and `TestTailwindConfigGenerator`) actually correct?**
  _`TailwindConfigGenerator` has 2 INFERRED edges - model-reasoned connections that need verification._
- **What connects `supabase`, `fs`, `path` to the rest of the system?**

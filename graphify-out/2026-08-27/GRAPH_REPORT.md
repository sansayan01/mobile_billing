...
## Corpus Check
- 460 files · ~1,948,167 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8000 nodes · 11157 edges · 479 communities (417 shown, 62 thin omitted)
...
1. `Memory — Session Log & Context` - 115 edges
2. `AuthBloc` - 73 edges
...
## Communities (479 total, 62 thin omitted)
...
Cohesion: 0.05
Nodes (54): AddCategory, categories, CategoryEvent, CategoryState, CategoryStatus, colorValue, copyWith, DeleteCategoriesBulk (+46 more)
...
Cohesion: 0.04
Nodes (59): appBarTheme, b, buildActions, _buildDescriptionSnippet, _buildInsightsSection, buildLeading, _buildLoadingPlaceholder, _buildQuickTiles (+51 more)
...
Cohesion: 0.04
Nodes (65): ../../../../core/utils/csv_export_import.dart, AddProduct, AddProductsBulk, DeleteProduct, InitRealtime, ProductEvent, ProductsRealtimeUpdated, ProductState (+57 more)

### Community 12 - "due_payments_bloc.dart"
Cohesion: 0.10
Nodes (30): amount, billId, ClearDueMessages, CollectPayment, copyWith, duePayments, DuePaymentsEvent, DuePaymentsState (+22 more)
...
Cohesion: 0.06
Nodes (32): _actionBtn, _allDialKey, _badge, _bottomPanel, build, _buildDial, categoryName, categoryNames (+24 more)

### Community 18 - "receipt_preview_page.dart"
Cohesion: 0.05
Nodes (39): ../../../../core/theme/app_typography.dart, ../../../../core/widgets/adaptive_app_bar_leading.dart, GlobalKey, address1, address2, amountPaid, billId, cartItems (+31 more)

### Community 19 - "ReportBloc"
Cohesion: 0.04
Nodes (70): _HeroSalesCard, _loadDashboardData, _LowStockBanner, _PaymentMethodsSection, _StaffPerformanceSection, ReportBloc, billId, changeType (+62 more)
...
Cohesion: 0.07
Nodes (29): _animController, build, _buildDateButton, _buildDateRange, _buildEmptyState, _buildGroupedCard, _buildMovementCard, _buildStaffAndGroupControls (+21 more)

### Community 23 - "package:flutter/material.dart"
Cohesion: 0.04
Nodes (58): IconData?, AppBackButton, icon, size, build, GreetingHeader, _monthName, userName (+50 more)
...
Cohesion: 0.06
Nodes (30): core/data/hive_database.dart, core/supabase/supabase_client.dart, dart:async, ../../domain/entities/product.dart, ../../domain/repositories/product_repository.dart, addProduct, deleteProduct, _fromMap (+22 more)
...
Cohesion: 0.05
Nodes (36): dart:io, dart:math, dart:typed_data, ../../features/damaged_products/domain/entities/damaged_product.dart, ../../../../features/product/domain/entities/product.dart, BeepHelper, _beepPath, dispose (+28 more)

### Community 32 - "category_list_page.dart"
Cohesion: 0.06
Nodes (39): add_edit_category_dialog.dart, FilterByCategory, ../../domain/usecases/category_usecases.dart, _buildEmptySearch, _buildEmptyState, _buildRecentlyUsed, _buildStatsCard, _categoryCard (+31 more)

### Community 33 - "State"
Cohesion: 0.06
Nodes (52): DamagedProductsEvent, FilterDamagedProductsByDate, LoadDamagedProducts, MarkProductAsDamaged, SearchDamagedProducts, UndoDamagedProduct, LoadProducts, CheckoutPage (+44 more)
...
Cohesion: 0.04
Nodes (60): ../bloc/product_bloc.dart, ../../../category/domain/entities/category.dart, ../../../../core/utils/image_compress.dart, ../../../../core/utils/image_upload_service.dart, File?, AddProductPage, _AddProductPageState, _barcodeController (+52 more)
...
Cohesion: 0.05
Nodes (39): _applyTimeRange, _buildBarChart, _buildBestSelling, _buildDateNav, _buildHourlyHeatmap, _buildPaymentSplit, _buildStatCards, _buildSummaryHeader (+31 more)
...
Cohesion: 0.04
Nodes (53): AuthRepositoryImpl, AuthRepository, call, GetCurrentUserUseCase, repository, call, email, LoginParams (+45 more)

### Community 71 - "shop_model.dart"
Cohesion: 0.09
Nodes (23): @HiveType, ProductModelAdapter, hashCode, operator, read, ShopModelAdapter, typeId, write (+15 more)
...
Cohesion: 0.06
Nodes (40): class, ../entities/product.dart, UseCase, AddProductUseCase, call, DeleteProductUseCase, GetCurrentStockBulkUseCase, GetProductByBarcodeUseCase (+32 more)
...
Cohesion: 0.05
Nodes (45): audit_event.dart, audit_state.dart, FormState, currentRoute, _DrawerItem, icon, _initials, label (+37 more)
...
Cohesion: 0.08
Nodes (29): BillingState, Equatable, CartItem, BillDetailParams, BillHistoryParams, billId, call, changeType (+21 more)
...
Cohesion: 0.04
Nodes (52): ../config/app_config.dart, _anonKey, client, initialize, SupabaseConfig, _url, AuditRepositoryImpl, _fromJson (+44 more)
...
Cohesion: 0.03
Nodes (63): 2026-08-25 — App-wide navbar/FAB overlap audit + fix ⚡, 2026-08-25 — Dashboard v3.4 fix batch (This Week remove + first-run card + lazy slivers), 2026-08-25 — Dead Code Cleanup (11-item audit batch), 2026-08-25 — Deep navbar overlap re-audit (FAB + buttons + pinned CTAs) ⚡, 2026-08-25 — Money font rollout (report + due_payments), 2026-08-25 - Report/audit/dashboard fix batch (10 fixes), 2026-08-27 — GAP FIX ROLLOUT (ALL PAGES) ✅, [Audit-Fix Agent] 2026-08-25 — 14-fix audit batch (+55 more)
...
Cohesion: 0.07
Nodes (38): ../bloc/staff_bloc.dart, ../../../../core/theme/app_colors.dart, ../../../../core/widgets/app_feedback.dart, ../../../../core/widgets/app_skeleton.dart, copyWith, DeleteStaffMember, id, LoadStaff (+30 more)
...
### Community 149 - "bill_detail_page.dart"
Cohesion: 0.04
Nodes (62): ../../config/routes/app_shell.dart, _loadThemeMode, setThemeMode, toggleTheme, build, createState, dispose, _nameController (+54 more)
...
### Community 162 - "FloatingActionButtonLocation"
Cohesion: 0.40
...
Cohesion: 0.10
Nodes (19): DateTime, action, entityType, from, performedBy, props, searchQuery, to (+11 more)
...
### Community 307 - "Route /"
Cohesion: 0.14
Nodes (14): build, build, build, build, build, build, build, build (+6 more)
...
### Community 324 - ".claude/skills/design-system/scripts/generate-slide.py"
Cohesion: 0.15
Nodes (19): _e(), generate_chart_slide(), generate_cta_slide(), generate_deck(), generate_metrics_slide(), generate_problem_slide(), generate_solution_slide(), generate_testimonial_slide() (+11 more)
...
Cohesion: 0.05
Nodes (39): ../../../../core/error/failure.dart, ../../domain/entities/stock_adjustment.dart, ../../domain/entities/warranty_claim.dart, ../../domain/repositories/stock_repository.dart, ../../domain/repositories/warranty_repository.dart, ../entities/stock_adjustment.dart, ../entities/warranty_claim.dart, ../error/failure.dart (+31 more)
...
### Community 378 - "staff_repository_impl.dart"
Cohesion: 0.08
Nodes (21): ../../../auth/data/models/user_model.dart, ../../../auth/domain/entities/user.dart, ../../domain/repositories/staff_repository.dart, fromJson, fromProfileJson, fromSupabaseAuth, toJson, deleteStaffMember (+13 more)
...
- **Why does `search()` connect `search` to `_suggest_identities`, `detect_domain`, `.opencode/skills/ui-ux-pro-max/scripts/design_system.py`, `.opencode/skills/ui-ux-pro-max/scripts/core.py`, `_normalize`, `.opencode/skills/ui-ux-pro-max/scripts/validate_data.py`, `generate_design_system`, `BM25`, `.generate`, `test_text_layout_resilience.py`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `AuthBloc` connect `AuthBloc` to `billing_bloc.dart`, `warranty_bloc.dart`, `category_bloc.dart`, `printer_bloc.dart`, `dashboard_page.dart`, `app_routes.dart`, `due_payments_bloc.dart`, `service_locator.dart`, `product_bloc.dart`, `ReportBloc`, `bill_detail_page.dart`, `settings_page.dart`, `BillingBloc`, `State`, `checkout_page.dart`, `home_page.dart`, `Route /`, `quick_actions_panel.dart`, `add_staff_page.dart`, `customer_bloc.dart`, `auth_bloc.dart`, `report_bloc.dart`, `stock_bloc.dart`, `register_page.dart`, `damaged_products_bloc.dart`, `email_verification_page.dart`, `build`, `staff_bloc.dart`?**

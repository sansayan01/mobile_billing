...
## Corpus Check
- 339 files · ~1,694,394 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5529 nodes · 7980 edges · 335 communities (306 shown, 29 thin omitted)
...
- due_payments_repository_impl.dart
- shop.dart
- StatelessWidget
- phone_utils.dart
- app_bottom_nav.dart
...
1. `AuthBloc` - 76 edges
2. `Memory — Session Log & Context` - 75 edges
...
### Community 2 - "shop_bloc.dart"
Cohesion: 0.15
Nodes (22): LoadShopEvent, message, ShopError, ShopEvent, ShopInitial, ShopLoaded, ShopLoading, ShopOperationSuccess (+14 more)

### Community 3 - "audit_repository_impl.dart"
Cohesion: 0.14
...
Cohesion: 0.04
Nodes (49): CustomPainter, _SalesTrendPainter, _applyDateRange, BillHistoryPage, _BillHistoryPageState, _buildBillCard, _buildBillComparison, _buildPaymentPieChart (+41 more)

### Community 8 - "app_routes.dart"
Cohesion: 0.04
Nodes (44): app_shell.dart, ../../features/audit/presentation/bloc/audit_bloc.dart, ../../features/audit/presentation/bloc/audit_event.dart, ../../features/audit/presentation/pages/audit_timeline_page.dart, ../../features/auth/presentation/pages/email_verification_page.dart, ../../features/auth/presentation/pages/login_page.dart, ../../features/auth/presentation/pages/register_page.dart, ../../features/billing/domain/entities/cart_item.dart (+36 more)

### Community 9 - "payment_donut_chart.dart"
Cohesion: 0.15
...
Cohesion: 0.10
Nodes (19): amount, billId, copyWith, duePayments, DuePaymentsState, error, isCollecting, isLoading (+11 more)
...
Cohesion: 0.05
Nodes (61): ../../../../core/realtime/realtime_service.dart, AddProduct, categoryId, changeType, copyWith, DeleteProduct, FilterByCategory, filteredProducts (+53 more)
...
Cohesion: 0.07
Nodes (30): _actionBtn, _allDialKey, _badge, _bottomPanel, build, _buildDial, categoryName, categoryNames (+22 more)

### Community 18 - "receipt_preview_page.dart"
Cohesion: 0.07
Nodes (28): GlobalKey, address1, address2, amountPaid, billId, cartItems, createState, customerName (+20 more)

### Community 19 - "bill_detail_page.dart"
Cohesion: 0.08
Nodes (23): _actionBtn, bill, build, _buildCustomerHistory, _buildInfoCard, _buildPaymentStatusRow, _buildPaymentTimeline, _confirmDelete (+15 more)
...
### Community 23 - "add_product_page.dart"
Cohesion: 0.04
Nodes (55): ../bloc/product_bloc.dart, ../../../category/domain/entities/category.dart, ../../../../core/utils/image_compress.dart, ../../../../core/utils/image_upload_service.dart, File?, _barcodeController, build, _categoryController (+47 more)
...
Cohesion: 0.11
Nodes (17): ../bloc/warranty_bloc.dart, core/service_locator.dart, _buildClaimCard, _buildTypeFilterChip, createState, _detailRow, _isFetchingBill, _scanBillAndCreateClaim (+9 more)
...
Cohesion: 0.05
Nodes (41): Animation, AnimationController, AppSkeleton, AppSkeletonList, AppSkeletonListTile, _AppSkeletonState, build, _controller (+33 more)

### Community 28 - "stock_bloc.dart"
Cohesion: 0.10
Nodes (25): Bloc, adjustments, AdjustStock, copyWith, LoadAllAdjustments, LoadStockHistory, message, note (+17 more)

### Community 29 - "home_page.dart"
Cohesion: 0.05
Nodes (42): ../../../billing/presentation/bloc/billing_bloc.dart, core/utils/beep_helper.dart, ../../../../features/product/domain/repositories/product_repository.dart, ../../../../features/product/domain/usecases/product_usecases.dart, build, _buildBottomPanel, _buildCameraOffState, _buildCorner (+34 more)
...
Cohesion: 0.08
Nodes (41): AddCategory, categories, CategoryEvent, CategoryState, CategoryStatus, colorValue, copyWith, DeleteCategory (+33 more)
...
Cohesion: 0.06
Nodes (35): ../error/failure.dart, call, NoParams, AuthRepositoryImpl, AuthRepository, call, GetCurrentUserUseCase, repository (+27 more)
...
Cohesion: 0.10
Nodes (20): _bottomPad, build, _buildPlaceholder, _buildStatChip, _buildStatsRow, dotFillColor, _formatCurrency, _hasData (+12 more)
...
### Community 41 - "product_repository_impl.dart"
Cohesion: 0.08
Nodes (24): dart:async, ../../domain/entities/product.dart, ../../domain/repositories/product_repository.dart, addProduct, deleteProduct, _fromMap, getCurrentStockBulk, getProductByBarcode (+16 more)

### Community 42 - "category_repository_impl.dart"
Cohesion: 0.04
Nodes (51): ../../../auth/data/models/user_model.dart, ../../../auth/domain/entities/user.dart, core/data/hive_database.dart, ../../../../core/error/failure.dart, core/supabase/supabase_client.dart, ../../domain/entities/stock_adjustment.dart, ../../domain/entities/warranty_claim.dart, ../../domain/repositories/category_repository.dart (+43 more)

### Community 43 - "ReportBloc"
Cohesion: 0.08
Nodes (44): _loadDashboardData, _LowStockBanner, _MonthlyTrendSection, _RecentTransactions, ReportBloc, billId, changeType, date (+36 more)
...
### Community 47 - "damaged_products_repository_impl.dart"
Cohesion: 0.11
Nodes (17): DamagedProductsRepositoryImpl, getDamagedProducts, getDamagedProductsCount, getTotalDamageLoss, markAsDamaged, _resolveShopId, _resolveStaffName, _supabase (+9 more)

### Community 48 - "beep_helper.dart"
Cohesion: 0.07
...
### Community 52 - "Current Session: 2026-08-21 — Product Page: Remove Redundant Add Button ✅"
Cohesion: 0.67
...
Cohesion: 0.12
Nodes (17): ../../../auth/presentation/bloc/auth_bloc.dart, ../../../auth/presentation/bloc/auth_state.dart, ../../../../core/widgets/input_label.dart, ../../../../core/widgets/primary_button.dart, AddStaffPage, _AddStaffPageState, build, createState (+9 more)
...
### Community 61 - "List"
Cohesion: 0.09
Nodes (23): CacheFailure, Failure, message, props, ServerFailure, colorValue, copyWith, createdAt (+15 more)
...
### Community 67 - "printer_repository.dart"
Cohesion: 0.17
...
Cohesion: 0.08
Nodes (30): BillingState, Equatable, UserModel, User, SignUpParams, BillDetailParams, BillHistoryParams, billId (+22 more)

### Community 72 - ".application"
Cohesion: 0.15
Nodes (10): Bool, Flutter, FlutterAppDelegate, AppDelegate, Any, RunnerTests, UIApplication, UIKit (+2 more)

### Community 73 - "auth_bloc.dart"
Cohesion: 0.08
...
### Community 74 - "package:intl/intl.dart"
Cohesion: 0.18
Nodes (10): ../../features/damaged_products/domain/entities/damaged_product.dart, ../../../../features/product/domain/entities/product.dart, CsvExportImport, exportDamagedProducts, exportProducts, importProducts, package:csv/csv.dart, package:file_picker/file_picker.dart (+2 more)

### Community 75 - "hive_database.dart"
Cohesion: 0.11
Nodes (19): @HiveType, ProductModelAdapter, ShopModelAdapter, ../../features/product/data/models/product_model.dart, ../../features/shop/data/models/shop_model.dart, HiveDatabase, init, productBox (+11 more)
...
### Community 77 - "printer_bloc.dart"
Cohesion: 0.20
...
Cohesion: 0.12
Nodes (25): AuditBloc, action, AuditEvent, description, entityId, entityName, entityType, from (+17 more)
...
### Community 80 - "premium_stat_card.dart"
Cohesion: 0.12
Nodes (15): Color, IconData?, build, color, icon, label, PremiumStatCard, value (+7 more)

### Community 81 - "warranty_usecases.dart"
Cohesion: 0.15
...
### Community 84 - "report_repository_impl.dart"
Cohesion: 0.08
...
### Community 86 - "package:go_router/go_router.dart"
Cohesion: 0.11
Nodes (18): ../../config/routes/app_shell.dart, AdaptiveAppBarLeading, build, AppBackButton, build, icon, size, build (+10 more)

### Community 87 - "category_list_page.dart"
Cohesion: 0.05
Nodes (37): add_edit_category_dialog.dart, core/theme/app_theme.dart, ../../../../core/widgets/adaptive_app_bar_leading.dart, _buildEmptySearch, _buildEmptyState, _buildStatsCard, _categoryCard, _confirmSwipeDelete (+29 more)
...
Cohesion: 0.12
Nodes (14): AppFeedback, error, FeedbackType, info, _show, success, build, InputLabel (+6 more)

### Community 93 - "due_payments_repository_impl.dart"
Cohesion: 0.13
...
### Community 94 - "shop.dart"
Cohesion: 0.20
Nodes (9): addressLine1, addressLine2, copyWith, footerText, id, name, phoneNumber, props (+1 more)

### Community 95 - "StatelessWidget"
Cohesion: 0.08
Nodes (28): features/auth/presentation/bloc/auth_bloc.dart, _ActionsPanel, build, _CloseButton, icon, item, label, open (+20 more)

### Community 96 - "phone_utils.dart"
Cohesion: 0.33
Nodes (5): cleaned, isValidPhone, normalized, normalizePhone, return

### Community 97 - "app_bottom_nav.dart"
Cohesion: 0.12
...
### Community 99 - "package:billing_app/core/error/failure.dart"
Cohesion: 0.08
Nodes (24): fromJson, fromProfileJson, fromSupabaseAuth, toJson, authStateChanges, getCurrentUser, login, loginWithGoogle (+16 more)

### Community 100 - "manifest.json"
Cohesion: 0.18
Nodes (10): background_color, description, display, icons, name, orientation, prefer_related_applications, short_name (+2 more)

### Community 101 - "StatefulWidget"
Cohesion: 0.13
Nodes (15): PrimaryButton, _PrimaryButtonState, CheckoutPage, HomePage, AddEditCategoryDialog, CategoryListPage, MarkDamagedDialog, _MarkDamagedDialogState (+7 more)
...
### Community 103 - "staff_performance_card.dart"
Cohesion: 0.14
Nodes (13): _avatarColor, billCount, build, _buildGlassContainer, _initial, name, revenue, _short (+5 more)

### Community 104 - "Current Session: 2026-07-18 — Dashboard Product Search ✅"
Cohesion: 0.67
...
Cohesion: 0.05
Nodes (44): BUG FIX 7: 2026-08-21 back button black screen on Due Payments / Damaged / Customers, Current Session: 2026-07-18 — Product Detail Page + Dashboard Search Navigation ✅, Current Session: 2026-07-21 — Billing History Section Audit + Warnings Fix ✅, Current Session: 2026-07-21 — Cleaned up Flutter Analyzer Linter Suggestions ✅, Current Session: 2026-07-21 — Description Match Snippet Highlight on Search ✅, Current Session: 2026-07-21 — Fixed Category "All" Selection Not Clearing ✅, Current Session: 2026-07-21 — Fixed Category Chip Highlight State Sync ✅, Current Session: 2026-07-21 — Layout + Routing Fixes ✅ (+36 more)

### Community 108 - "DesignSystemGenerator"
Cohesion: 0.06
...
### Community 109 - "AuthBloc"
Cohesion: 0.09
Nodes (38): AuthBloc, AuthEvent, CheckAuthStatus, GoogleLoginRequested, LoginRequested, ResendVerificationEmailRequested, UpdateProfileRequested, Authenticated (+30 more)
...
Cohesion: 0.08
Nodes (35): ../bloc/staff_bloc.dart, ../../../../core/widgets/app_feedback.dart, ../../../../core/widgets/app_skeleton.dart, copyWith, DeleteStaffMember, id, LoadStaff, message (+27 more)
...
### Community 157 - "Current Session: 2026-07-21 — Fixed Category Switch Animation Glitch ✅"
Cohesion: 0.67
...
### Community 160 - "Current Session: 2026-07-21 — Ultra-Compact Product Cards + Alignment Fix ✅"
Cohesion: 0.67
...
### Community 162 - "shop_details_page.dart"
Cohesion: 0.12
...
### Community 163 - "Current Session: 2026-07-28 — README.md Update ✅"
Cohesion: 0.67
...
### Community 165 - "app_drawer.dart"
Cohesion: 0.08
Nodes (27): FormState, currentRoute, _DrawerItem, icon, _initials, label, onTap, _ProfileHeader (+19 more)
...
### Community 170 - "_select_palette_for_mode"
Cohesion: 0.11
...
### Community 182 - "damaged_products_bloc.dart"
Cohesion: 0.05
...
### Community 193 - "app_shell.dart"
Cohesion: 0.15
Nodes (12): core/navigation/navigation_cubit.dart, ../../core/widgets/app_bottom_nav.dart, ../../core/widgets/app_drawer.dart, AppShell, build, child, _fullScreenRoutes, scaffoldKey (+4 more)
...
Cohesion: 0.11
Nodes (17): build, GreetingHeader, _monthName, userName, build, _buildGlassContainer, color, count (+9 more)
...
### Community 198 - "shop_usecases.dart"
Cohesion: 0.17
...
### Community 200 - "customer_list_page.dart"
Cohesion: 0.10
Nodes (21): AddCustomerPage, _AddCustomerPageState, build, createState, dispose, _nameController, _phoneController, _save (+13 more)
...
Cohesion: 0.13
Nodes (14): EdgeInsetsGeometry, borderRadius, build, createState, elevation, icon, isFullWidth, isLoading (+6 more)
...
### Community 205 - "top_products_bar_chart.dart"
Cohesion: 0.15
...
### Community 212 - "dashboard_action_card.dart"
Cohesion: 0.18
...
Cohesion: 0.22
Nodes (8): email, name, password, props, role, shopId, shopName, String?

### Community 218 - "package:flutter_bloc/flutter_bloc.dart"
Cohesion: 0.08
Nodes (31): ../../../auth/presentation/bloc/auth_event.dart, ../bloc/printer_bloc.dart, ../bloc/printer_event.dart, ../bloc/printer_state.dart, core/theme/theme_cubit.dart, Cubit, AppNavigationMode, _loadMode (+23 more)
...
Cohesion: 0.14
Nodes (20): DateTime, _e(), generate_chart_slide(), generate_cta_slide(), generate_deck(), generate_metrics_slide(), generate_problem_slide(), generate_solution_slide() (+12 more)
...
### Community 227 - "build"
Cohesion: 0.18
Nodes (19): build, build, _buildQuickTiles, build, Route /categories, Route /customers, Route /damaged-products, Route /due-payments (+11 more)
...
### Community 247 - "printer_state.dart"
Cohesion: 0.17
Nodes (11): connecting,
  connected,
  connectionFailure,
...
### Community 248 - "due_payments_page.dart"
Cohesion: 0.21
Nodes (17): CollectPayment, DuePaymentsEvent, LoadDuePayments, SearchDuePayments, DuePaymentsBloc, build, _buildDuePaymentCard, createState (+9 more)
...
### Community 288 - "Current Session: 2026-07-18 — Product Card Tap + Description Copy + Extra Fields ✅"
Cohesion: 0.67
...
### Community 305 - "foreground"
Cohesion: 0.67
Nodes (3): foreground, $type, $value

### Community 306 - "muted-foreground"
Cohesion: 0.67
Nodes (3): muted-foreground, $type, $value

### Community 307 - "primary-hover"
Cohesion: 0.67
Nodes (3): primary-hover, $type, $value

### Community 311 - "customer_repository_impl.dart"
Cohesion: 0.12
...
### Community 317 - "Current Session: 2026-07-21 — Description Search on Product Management Page ✅"
Cohesion: 0.67
...
### Community 329 - "Current Session: 2026-07-22 — Staff Widget Owner-Only (Dashboard + Drawer + Route Guard) ✅"
Cohesion: 0.67
Nodes (3): Current Session: 2026-07-22 — Staff Widget Owner-Only (Dashboard + Drawer + Route Guard) ✅, flutter analyze, What Was Done

## Knowledge Gaps
- **3061 isolated node(s):** `supabase`, `fs`, `path`, `fs`, `path` (+3056 more)
...
- **Why does `search()` connect `search` to `.generate`, `detect_domain`, `search_stack`, `design_system.py`, `validate_data.py`, `scripts/core.py`, `test_text_layout_resilience.py`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `AuthBloc` connect `AuthBloc` to `billing_bloc.dart`, `warranty_bloc.dart`, `dashboard_page.dart`, `app_routes.dart`, `due_payments_bloc.dart`, `product_bloc.dart`, `main.dart`, `bill_detail_page.dart`, `stock_bloc.dart`, `home_page.dart`, `BillingBloc`, `category_bloc.dart`, `checkout_page.dart`, `app_drawer.dart`, `ReportBloc`, `damaged_products_bloc.dart`, `add_staff_page.dart`, `customer_bloc.dart`, `report_bloc.dart`, `auth_bloc.dart`, `register_page.dart`, `audit_bloc.dart`, `package:flutter_bloc/flutter_bloc.dart`, `StatelessWidget`, `build`, `staff_bloc.dart`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `DesignSystemGenerator` connect `DesignSystemGenerator` to `.generate`, `detect_domain`, `_select_palette_for_mode`, `search`, `design_system.py`, `scripts/core.py`?**
